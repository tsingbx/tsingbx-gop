...
//line cmd/xgo/build_cmd.gox:20:1
	this.Use("build [-debug -o output] [packages]")
...
//line cmd/xgo/doc_cmd.gox:20:1
	this.Use("doc [-u -all -debug] [pkgPath]")
...
//line cmd/xgo/install_cmd.gox:20:1
	this.Use("install [-debug] [packages]")
...
//line cmd/xgo/mod_download_cmd.gox:20:1
	this.Use("mod download [-x -json] [modules]")
...
//line cmd/xgo/mod_init_cmd.gox:20:1
	this.Use("mod init [-llgo -tinygo] module-path")
...
//line cmd/xgo/run_cmd.gox:20:1
	this.Use("run [-nc -asm -quiet -debug -prof] package [arguments...]")
